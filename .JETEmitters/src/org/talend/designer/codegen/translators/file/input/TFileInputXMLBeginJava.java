...
public class TFileInputXMLBeginJava
{
  ...
  protected final String TEXT_430 = NL + "\tif(xml_api_";
  protected final String TEXT_431 = ".getNodeType(tmp_";
  protected final String TEXT_432 = ",";
  protected final String TEXT_433 = ")==org.apache.xpath.objects.XObject.CLASS_NODESET){" + NL + "\t\tnode_";
  protected final String TEXT_434 = " = xml_api_";
  protected final String TEXT_435 = ".getSingleNode(tmp_";
  protected final String TEXT_436 = ",";
  protected final String TEXT_437 = ");";
  protected final String TEXT_438 = NL + "    \tif(node_";
  protected final String TEXT_439 = "!=null && node_";
  protected final String TEXT_440 = ".getNodeType()==org.w3c.dom.Node.ELEMENT_NODE && node_";
  protected final String TEXT_441 = ".hasChildNodes()){" + NL + "    \t\tstr_";
  protected final String TEXT_442 = " = contentTool_";
  protected final String TEXT_443 = ".getNodeContent(node_";
  protected final String TEXT_444 = ");" + NL + "    \t}else{" + NL + "    \t\tstr_";
  protected final String TEXT_445 = " = node_";
  protected final String TEXT_446 = "!=null?node_";
  protected final String TEXT_447 = ".getTextContent():\"\";" + NL + "    \t}";
  protected final String TEXT_448 = NL + "\t\tstr_";
  protected final String TEXT_449 = " = node_";
  protected final String TEXT_450 = "!=null?node_";
  protected final String TEXT_451 = ".getTextContent():\"\";";
  protected final String TEXT_452 = NL + "\t}else{" + NL + "\t\tnode_";
  protected final String TEXT_453 = " = tmp_";
  protected final String TEXT_454 = ";" + NL + "\t\tstr_";
  protected final String TEXT_455 = " = xml_api_";
  protected final String TEXT_456 = ".getNodeString(tmp_";
  protected final String TEXT_457 = ",";
  protected final String TEXT_458 = ");" + NL + "\t}";
  protected final String TEXT_459 = NL + "\tif(true) {" + NL + "\t\tthrow new RuntimeException(\"Error Config: \\\"Get Nodes\\\" should be checked when type is \\\"Document\\\"\");" + NL + "\t}";
  protected final String TEXT_460 = NL + "    Object obj";
  protected final String TEXT_461 = "_";
  protected final String TEXT_462 = " = xpaths_";
  protected final String TEXT_463 = ".get(";
  protected final String TEXT_464 = ").evaluate(temp_";
  protected final String TEXT_465 = ");" + NL + "    if(obj";
  protected final String TEXT_466 = "_";
  protected final String TEXT_467 = " == null) {" + NL + "    \tnode_";
  protected final String TEXT_468 = " = null;";
  protected final String TEXT_469 = NL + "\t\tstr_";
  protected final String TEXT_470 = " = null;";
  protected final String TEXT_471 = NL + "    \tstr_";
  protected final String TEXT_472 = " = \"\";";
  protected final String TEXT_473 = NL + "    \t" + NL + "    } else if(obj";
  protected final String TEXT_474 = "_";
  protected final String TEXT_475 = " instanceof org.dom4j.Node) {" + NL + "    \tnode_";
  protected final String TEXT_476 = " = (org.dom4j.Node)obj";
  protected final String TEXT_477 = "_";
  protected final String TEXT_478 = ";";
  protected final String TEXT_479 = NL + "\t\tstr_";
  protected final String TEXT_480 = " = node_";
  protected final String TEXT_481 = ".asXML();";
  protected final String TEXT_482 = NL + "    \tstr_";
  protected final String TEXT_483 = " = org.jaxen.function.StringFunction.evaluate(node_";
  protected final String TEXT_484 = ",org.jaxen.dom4j.DocumentNavigator.getInstance());";
  protected final String TEXT_485 = NL + "    } else if(obj";
  protected final String TEXT_486 = "_";
  protected final String TEXT_487 = " instanceof String || obj";
  protected final String TEXT_488 = "_";
  protected final String TEXT_489 = " instanceof Number){" + NL + "    \tnode_";
  protected final String TEXT_490 = " = temp_";
  protected final String TEXT_491 = ";" + NL + "    \tstr_";
  protected final String TEXT_492 = " = String.valueOf(obj";
  protected final String TEXT_493 = "_";
  protected final String TEXT_494 = ");" + NL + "    } else if(obj";
  protected final String TEXT_495 = "_";
  protected final String TEXT_496 = " instanceof java.util.List){" + NL + "    \tjava.util.List<org.dom4j.Node> nodes_";
  protected final String TEXT_497 = " = (java.util.List<org.dom4j.Node>)obj";
  protected final String TEXT_498 = "_";
  protected final String TEXT_499 = ";" + NL + "    \tnode_";
  protected final String TEXT_500 = " = nodes_";
  protected final String TEXT_501 = ".size()>0 ? nodes_";
  protected final String TEXT_502 = ".get(0) : null;";
  protected final String TEXT_503 = NL + "\t\tstr_";
  protected final String TEXT_504 = " = node_";
  protected final String TEXT_505 = "==null?null:node_";
  protected final String TEXT_506 = ".asXML();";
  protected final String TEXT_507 = NL + "    \tstr_";
  protected final String TEXT_508 = " = node_";
  protected final String TEXT_509 = "==null?\"\":org.jaxen.function.StringFunction.evaluate(node_";
  protected final String TEXT_510 = ",org.jaxen.dom4j.DocumentNavigator.getInstance());";
  protected final String TEXT_511 = NL + "\t}";
  protected final String TEXT_512 = NL + "\tstr_";
  protected final String TEXT_513 = " = row_";
  protected final String TEXT_514 = ".get(";
  protected final String TEXT_515 = ");";
  protected final String TEXT_516 = NL + "\tnode_";
  protected final String TEXT_517 = " = new String[]{str_";
  protected final String TEXT_518 = ",row_";
  protected final String TEXT_519 = ".get(";
  protected final String TEXT_520 = "+\"/@xsi:nil\")};";
  protected final String TEXT_521 = NL + "\tnode_";
  protected final String TEXT_522 = " = new String[]{str_";
  protected final String TEXT_523 = ",null};";
  protected final String TEXT_524 = NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_525 = ".";
  protected final String TEXT_526 = " = ParserUtils.parseTo_Document(str_";
  protected final String TEXT_527 = ",";
  protected final String TEXT_528 = ",";
  protected final String TEXT_529 = ");";
  protected final String TEXT_530 = NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_531 = ".";
  protected final String TEXT_532 = " = str_";
  protected final String TEXT_533 = ";";
  protected final String TEXT_534 = NL + "\t\t\t\t\t\t\t\t\tif(xml_api_";
  protected final String TEXT_535 = ".isDefNull(node_";
  protected final String TEXT_536 = ")){" + NL + "\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_537 = ".";
  protected final String TEXT_538 = " =null;" + NL + "\t\t\t\t\t\t\t\t\t}else if(xml_api_";
  protected final String TEXT_539 = ".isEmpty(node_";
  protected final String TEXT_540 = ")){" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_541 = ".";
  protected final String TEXT_542 = " =\"\";" + NL + "\t\t\t\t\t\t\t\t\t}else if(xml_api_";
  protected final String TEXT_543 = ".isMissing(node_";
  protected final String TEXT_544 = " )){ " + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_545 = ".";
  protected final String TEXT_546 = " =";
  protected final String TEXT_547 = ";" + NL + "\t\t\t\t\t\t\t\t\t}else{";
  protected final String TEXT_548 = NL + "\t\t\t\t\t\t\t\t\tif(xml_api_";
  protected final String TEXT_549 = ".isEmpty(node_";
  protected final String TEXT_550 = ")){" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_551 = ".";
  protected final String TEXT_552 = " =\"\";" + NL + "\t\t\t\t\t\t\t\t\t}else if(xml_api_";
  protected final String TEXT_553 = ".isMissing(node_";
  protected final String TEXT_554 = " )){ " + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_555 = ".";
  protected final String TEXT_556 = " =";
  protected final String TEXT_557 = ";" + NL + "\t\t\t\t\t\t\t\t\t}else{";
  protected final String TEXT_558 = "\t" + NL + "\t\t\t\t\t\t\t\t\t\tif(xml_api_";
  protected final String TEXT_559 = ".isDefNull(node_";
  protected final String TEXT_560 = ")){" + NL + "\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_561 = ".";
  protected final String TEXT_562 = " =null;" + NL + "\t\t\t\t\t\t\t\t\t\t}else if(xml_api_";
  protected final String TEXT_563 = ".isEmpty(node_";
  protected final String TEXT_564 = ") || xml_api_";
  protected final String TEXT_565 = ".isMissing(node_";
  protected final String TEXT_566 = ")){" + NL + "\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_567 = ".";
  protected final String TEXT_568 = "=";
  protected final String TEXT_569 = ";" + NL + "\t\t\t\t\t\t\t\t\t\t}else{";
  protected final String TEXT_570 = NL + "\t\t\t\t\t\t\t\t\t\tif(xml_api_";
  protected final String TEXT_571 = ".isMissing(node_";
  protected final String TEXT_572 = ") || xml_api_";
  protected final String TEXT_573 = ".isEmpty(node_";
  protected final String TEXT_574 = ")){" + NL + "\t\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_575 = ".";
  protected final String TEXT_576 = " =";
  protected final String TEXT_577 = ";" + NL + "\t\t\t\t\t\t\t\t\t\t}else{";
  protected final String TEXT_578 = NL + "\t\t";
  protected final String TEXT_579 = ".";
  protected final String TEXT_580 = " = str_";
  protected final String TEXT_581 = ";";
  protected final String TEXT_582 = NL + "\t\t";
  protected final String TEXT_583 = ".";
  protected final String TEXT_584 = " = ParserUtils.parseTo_Date(str_";
  protected final String TEXT_585 = ", ";
  protected final String TEXT_586 = ",false);";
  protected final String TEXT_587 = NL + "\t\t";
  protected final String TEXT_588 = ".";
  protected final String TEXT_589 = " = ParserUtils.parseTo_Date(str_";
  protected final String TEXT_590 = ", ";
  protected final String TEXT_591 = ");";
  protected final String TEXT_592 = "\t\t\t\t\t\t\t" + NL + "\t\t";
  protected final String TEXT_593 = ".";
  protected final String TEXT_594 = " = str_";
  protected final String TEXT_595 = ".getBytes(";
  protected final String TEXT_596 = ");";
  protected final String TEXT_597 = NL + "\t\t";
  protected final String TEXT_598 = ".";
  protected final String TEXT_599 = " = ParserUtils.parseTo_";
  protected final String TEXT_600 = "(ParserUtils.parseTo_Number(str_";
  protected final String TEXT_601 = ", ";
  protected final String TEXT_602 = ", ";
  protected final String TEXT_603 = "));";
  protected final String TEXT_604 = NL + "\t\t";
  protected final String TEXT_605 = ".";
  protected final String TEXT_606 = " = ParserUtils.parseTo_";
  protected final String TEXT_607 = "(str_";
  ...
  protected final String TEXT_615 = NL + "\tboolean whetherReject_";
  protected final String TEXT_616 = " = false;" + NL + "\t";
  protected final String TEXT_617 = " = new ";
  protected final String TEXT_618 = "Struct();" + NL + "\ttry{";
  protected final String TEXT_619 = " ";
  protected final String TEXT_620 = " ";
  protected final String TEXT_621 = " = null; ";
  protected final String TEXT_622 = NL + "\t\t\t" + NL + "    } catch (java.lang.Exception e) {" + NL + "        whetherReject_";
  protected final String TEXT_623 = " = true;";
  protected final String TEXT_624 = NL + "            throw(e);";
  protected final String TEXT_625 = NL + "\t\t\t\tlog.error(\"";
  protected final String TEXT_626 = " - \" + e.getMessage());" + NL + "\t\t\t";
  ...
  protected final String TEXT_631 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_632 = ";";
  protected final String TEXT_633 = NL + "                ";
  protected final String TEXT_634 = " = null;";
  protected final String TEXT_635 = NL + "                System.err.println(e.getMessage());";
  ...
  protected final String TEXT_657 = NL + "\t" + NL + "\tif (nb_line_";
  protected final String TEXT_658 = ">";
  protected final String TEXT_659 = ") {" + NL + "\t";
  protected final String TEXT_660 = NL + "\t\t\tlooper_";
  protected final String TEXT_661 = ".stopRead();" + NL + "\t";
  protected final String TEXT_662 = NL + "\t\tbreak;" + NL + "\t}";
