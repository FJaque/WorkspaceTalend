...
public class TS3PutBeginJava
{
  ...
  protected final String TEXT_182 = " = false;" + NL + "\tString key_";
  protected final String TEXT_183 = " = ";
  protected final String TEXT_184 = ";" + NL + "\tlong partSizeInBytes_";
  protected final String TEXT_185 = " = ";
  protected final String TEXT_186 = " * 1024 * 1024;" + NL + "\ttry{" + NL + "\t\t";
  protected final String TEXT_187 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_188 = " - Uploading an object with key:\" + key_";
  protected final String TEXT_189 = ");" + NL + "\t\t";
  protected final String TEXT_190 = NL + "\t\tjava.io.File inputFile_";
  protected final String TEXT_191 = " = new java.io.File(";
  protected final String TEXT_192 = ");" + NL + "\t\tmultiUpload_";
  protected final String TEXT_193 = " = (inputFile_";
  protected final String TEXT_194 = ".length() > partSizeInBytes_";
  protected final String TEXT_195 = ") && (partSizeInBytes_";
  protected final String TEXT_196 = " >= 5 * 1024 * 1024);" + NL + "\t\tif(!multiUpload_";
  protected final String TEXT_197 = ") {" + NL + "\t\tcom.amazonaws.services.s3.model.PutObjectRequest putRequest_";
  protected final String TEXT_198 = " = new com.amazonaws.services.s3.model.PutObjectRequest(";
  protected final String TEXT_199 = ", key_";
  protected final String TEXT_200 = ", inputFile_";
  protected final String TEXT_201 = ");" + NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_202 = NL + "\t\t\tcom.amazonaws.services.s3.model.ObjectMetadata objectMetadata_";
  protected final String TEXT_203 = " = new com.amazonaws.services.s3.model.ObjectMetadata();" + NL + "\t\t\tobjectMetadata_";
  protected final String TEXT_204 = ".setSSEAlgorithm(com.amazonaws.services.s3.model.ObjectMetadata.AES_256_SERVER_SIDE_ENCRYPTION);" + NL + "\t\t\tputRequest_";
  protected final String TEXT_205 = ".setMetadata(objectMetadata_";
  protected final String TEXT_206 = ");" + NL + "\t\t";
  protected final String TEXT_207 = NL + "\t\t" + NL + "\t\tconn_";
  protected final String TEXT_208 = ".putObject(putRequest_";
  protected final String TEXT_209 = ");" + NL + "\t\t} else {" + NL + "\t\t\tlong filePosition_";
  protected final String TEXT_210 = " = 0;" + NL + "\t\t\tjava.util.List<com.amazonaws.services.s3.model.PartETag> partTags_";
  protected final String TEXT_211 = " = new java.util.ArrayList<com.amazonaws.services.s3.model.PartETag>();" + NL + "\t\t\tcom.amazonaws.services.s3.model.InitiateMultipartUploadRequest initRequest_";
  protected final String TEXT_212 = " = new com.amazonaws.services.s3.model.InitiateMultipartUploadRequest(";
  protected final String TEXT_213 = ", key_";
  protected final String TEXT_214 = ");" + NL + "\t\t\t";
  protected final String TEXT_215 = NL + "\t\t\t\tcom.amazonaws.services.s3.model.ObjectMetadata objectMetadata_";
  protected final String TEXT_216 = " = new com.amazonaws.services.s3.model.ObjectMetadata();" + NL + "\t\t\t\tobjectMetadata_";
  protected final String TEXT_217 = ".setSSEAlgorithm(com.amazonaws.services.s3.model.ObjectMetadata.AES_256_SERVER_SIDE_ENCRYPTION);" + NL + "\t\t\t\tinitRequest_";
  protected final String TEXT_218 = ".setObjectMetadata(objectMetadata_";
  protected final String TEXT_219 = ");" + NL + "\t\t\t";
  protected final String TEXT_220 = NL + "\t\t\tcom.amazonaws.services.s3.model.InitiateMultipartUploadResult initResponse_";
  protected final String TEXT_221 = " = conn_";
  protected final String TEXT_222 = ".initiateMultipartUpload(initRequest_";
  protected final String TEXT_223 = ");" + NL + "\t\t\tString uploadId_";
  protected final String TEXT_224 = " = initResponse_";
  protected final String TEXT_225 = ".getUploadId();" + NL + "\t\t\tint partNumber_";
  protected final String TEXT_226 = " = 1;" + NL + "\t\t\ttry {" + NL + "\t\t\t\twhile (filePosition_";
  protected final String TEXT_227 = " < inputFile_";
  protected final String TEXT_228 = ".length()) {" + NL + "            \t\tlong curPartSize_";
  protected final String TEXT_229 = " = Math.min(partSizeInBytes_";
  protected final String TEXT_230 = ", inputFile_";
  protected final String TEXT_231 = ".length() - filePosition_";
  protected final String TEXT_232 = ");" + NL + "            \t\tcom.amazonaws.services.s3.model.UploadPartRequest uploadRequest = new com.amazonaws.services.s3.model.UploadPartRequest()" + NL + "                    \t.withBucketName(";
  protected final String TEXT_233 = ")" + NL + "                    \t.withKey(key_";
  protected final String TEXT_234 = ").withUploadId(uploadId_";
  protected final String TEXT_235 = ")" + NL + "                    \t.withPartNumber(partNumber_";
  protected final String TEXT_236 = ").withFileOffset(filePosition_";
  protected final String TEXT_237 = ").withFile(inputFile_";
  protected final String TEXT_238 = ").withPartSize(curPartSize_";
  protected final String TEXT_239 = ");" + NL + "" + NL + "            \t\t// Upload part and add response to our list." + NL + "            \t\tpartTags_";
  protected final String TEXT_240 = ".add(conn_";
  protected final String TEXT_241 = ".uploadPart(uploadRequest).getPartETag());" + NL + "            \t\tpartNumber_";
  protected final String TEXT_242 = "++;" + NL + "" + NL + "            \t\tfilePosition_";
  protected final String TEXT_243 = " += curPartSize_";
  protected final String TEXT_244 = ";" + NL + "        \t\t}" + NL + "        \t\tcom.amazonaws.services.s3.model.CompleteMultipartUploadRequest compRequest_";
  protected final String TEXT_245 = " = new com.amazonaws.services.s3.model.CompleteMultipartUploadRequest(";
  protected final String TEXT_246 = ", key_";
  protected final String TEXT_247 = "," + NL + "                    uploadId_";
  protected final String TEXT_248 = ", partTags_";
  protected final String TEXT_249 = ");" + NL + "            \tconn_";
  protected final String TEXT_250 = ".completeMultipartUpload(compRequest_";
  protected final String TEXT_251 = ");" + NL + "            } catch(java.lang.Exception uploadException_";
  protected final String TEXT_252 = ") {" + NL + "\t\t\t\tconn_";
  protected final String TEXT_253 = ".abortMultipartUpload(new com.amazonaws.services.s3.model.AbortMultipartUploadRequest(";
  protected final String TEXT_254 = ", key_";
  protected final String TEXT_255 = ", uploadId_";
  protected final String TEXT_256 = "));" + NL + "\t\t\t\tthrow uploadException_";
  protected final String TEXT_257 = ";" + NL + "            }" + NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_258 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_259 = " - Upload the object successfully.\");" + NL + "\t\t";
  ...
  protected final String TEXT_265 = " - \" + e_";
  protected final String TEXT_266 = ".getMessage());" + NL + "\t\t\t";
  protected final String TEXT_267 = NL + "\t\t\tSystem.err.println(e_";
  protected final String TEXT_268 = ".getMessage());" + NL + "\t\t";
  protected final String TEXT_269 = NL + "\t}finally{" + NL + "\t\tif(conn_";
  protected final String TEXT_270 = " !=null){" + NL + "\t\t\tconn_";
