...
public class TGoogleDriveCreateMainJava
{
  ...
  protected final String TEXT_58 = " || \"root\".equals(parentFolderId_";
  protected final String TEXT_59 = ")){" + NL + "\t\t    parentFolderId_";
  protected final String TEXT_60 = " = ";
  protected final String TEXT_61 = "_files.getItems().get(0).getId();" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_62 = NL + "\t\t" + NL + "\t\tString subFolderId_";
  protected final String TEXT_63 = " = null;" + NL + "\t\tString subFolderName_";
  protected final String TEXT_64 = " = ";
  protected final String TEXT_65 = ";" + NL + "\t\tif(null != subFolderName_";
  protected final String TEXT_66 = " && !\"\".equals(subFolderName_";
  protected final String TEXT_67 = ".trim())){" + NL + "\t\t\t";
  protected final String TEXT_68 = NL + "\t        ";
  protected final String TEXT_69 = "_createdFolder.setParents(java.util.Arrays.asList(new com.google.api.services.drive.model.ParentReference().setId(parentFolderId_";
  protected final String TEXT_70 = ")));" + NL + "\t        ";
  protected final String TEXT_71 = "_createdFolder.setMimeType(\"application/vnd.google-apps.folder\"); " + NL + "\t    \t";
  protected final String TEXT_72 = "_createdFolder.setTitle(subFolderName_";
  protected final String TEXT_73 = "); " + NL + "" + NL + "\t        ";
  protected final String TEXT_74 = "_resultFile = ";
  protected final String TEXT_75 = "_client.files().insert(";
  protected final String TEXT_76 = "_createdFolder).execute();" + NL + "\t        subFolderId_";
  protected final String TEXT_77 = " = ";
  protected final String TEXT_78 = "_resultFile.getId();" + NL + "\t\t}";
  protected final String TEXT_79 = NL + "\t\t\t";
  protected final String TEXT_80 = ".parentFolderID = parentFolderId_";
  protected final String TEXT_81 = ";" + NL + "\t\t\t";
  protected final String TEXT_82 = ".newFolderID = subFolderId_";
  protected final String TEXT_83 = ";";
  protected final String TEXT_84 = NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_85 = "_PARENTFOLDERID\", parentFolderId_";
  protected final String TEXT_86 = ");" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_87 = "_NEWFOLDERID\", subFolderId_";
