...
public class TESBConsumerMainJava
{
  ...
  protected final String TEXT_96 = NL + "                    esbFeatures_";
  protected final String TEXT_97 = ".add(new org.apache.cxf.transport.common.gzip.GZIPFeature());";
  protected final String TEXT_98 = NL + "                    esbFeatures_";
  protected final String TEXT_99 = ".add(new org.talend.esb.policy.correlation.feature.CorrelationIDFeature());";
  protected final String TEXT_100 = NL + "                    genericConsumer_";
  protected final String TEXT_101 = ".setCorrelationIDCallbackHandler(correlationIDCallbackHandler);";
  protected final String TEXT_102 = NL + "                genericConsumer_";
  protected final String TEXT_103 = ".setEsbFeatures(esbFeatures_";
  protected final String TEXT_104 = ");" + NL + "" + NL + "                boolean use_auth_";
  protected final String TEXT_105 = " = ";
  protected final String TEXT_106 = ";" + NL + "                if (use_auth_";
  protected final String TEXT_107 = ") {" + NL + "                    genericConsumer_";
  protected final String TEXT_108 = ".setAuthType((String) ";
  ...
  protected final String TEXT_120 = ");" + NL + "                }" + NL + "" + NL + "                boolean use_proxy_";
  ...
  protected final String TEXT_147 = NL + "                    genericConsumer_";
  protected final String TEXT_148 = ".setDisableChunking(";
  protected final String TEXT_149 = ");";
  protected final String TEXT_150 = NL + NL + "                genericConsumer_";
  protected final String TEXT_151 = ".setLogMessages(";
  ...
  protected final String TEXT_160 = NL + "                        System.setProperty(\"java.protocol.handler.pkgs\", \"com.sun.net.ssl.internal.www.protocol\");" + NL + "                        System.setProperty(\"javax.net.ssl.trustStore\", ";
  protected final String TEXT_161 = ");" + NL + "                        System.setProperty(\"javax.net.ssl.trustStorePassword\", decryptedPassword_";
  protected final String TEXT_162 = ");" + NL + "                    }";
  protected final String TEXT_163 = NL + NL + "                if (!soapHeaders_";
  protected final String TEXT_164 = ".isEmpty()) {" + NL + "                    genericConsumer_";
  protected final String TEXT_165 = ".setSoapHeaders(soapHeaders_";
  protected final String TEXT_166 = ");" + NL + "                }" + NL + "\t\t\t\t\t esbFeatures_";
  protected final String TEXT_167 = ".add(httpHeadersFeature);" + NL + "                responseDoc_";
  protected final String TEXT_168 = " = genericConsumer_";
  protected final String TEXT_169 = ".invoke(requestTalendDoc_";
  protected final String TEXT_170 = ".getDocument());";
  protected final String TEXT_171 = NL + "                    globalMap.put(\"";
  protected final String TEXT_172 = "_CORRELATION_ID\", genericConsumer_";
  protected final String TEXT_173 = ".getCorrelationID());";
  protected final String TEXT_174 = NL + "                globalMap.put(\"";
  protected final String TEXT_175 = "_HTTP_HEADERS\", httpHeadersFeature.getResponseHeaders());" + NL + "                globalMap.put(\"";
  protected final String TEXT_176 = "_HTTP_RESPONSE_CODE\", httpHeadersFeature.getResponseCode());" + NL + "            } else {" + NL + "                ESBConsumer consumer_";
  protected final String TEXT_177 = " = registry.createConsumer(" + NL + "                    new ESBEndpointInfo() {" + NL + "" + NL + "                        @SuppressWarnings(\"serial\")" + NL + "                        private java.util.Map<String, Object> props = new java.util.HashMap<String, Object>() {{" + NL + "                            put(\"dataFormat\", \"PAYLOAD\");" + NL + "                            put(\"portName\", portName_";
  protected final String TEXT_178 = ".toString());" + NL + "                            put(\"serviceName\", serviceName_";
  protected final String TEXT_179 = ".toString());" + NL + "                            put(\"defaultOperationName\", \"";
  protected final String TEXT_180 = "\");" + NL + "                            put(\"operationNamespace\", \"";
  protected final String TEXT_181 = "\");" + NL + "                            put(\"soapAction\", \"";
  protected final String TEXT_182 = "\");" + NL + "                            if (null != getClass().getResourceAsStream(\"wsdl/";
  protected final String TEXT_183 = ".wsdl\")) {" + NL + "                                put(\"wsdlURL\", \"classpath:/\" + this.getClass().getPackage().getName().replace(\".\", \"/\") + \"/wsdl/";
  protected final String TEXT_184 = ".wsdl\");" + NL + "                            }" + NL + "                            put(\"publishedEndpointUrl\", ";
  protected final String TEXT_185 = ");" + NL + "                            put(\"COMMUNICATION_STYLE\", \"";
  protected final String TEXT_186 = "\");" + NL + "" + NL + "                            put(\"logMessages\", ";
  protected final String TEXT_187 = ");" + NL + "" + NL + "                            // use Service Locator" + NL + "                            put(\"useServiceLocator\", ";
  protected final String TEXT_188 = ");";
  protected final String TEXT_189 = NL + "                                put(\"LocatorSelectionStrategy\", \"";
  protected final String TEXT_190 = "\");";
  protected final String TEXT_191 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_192 = NL + "                                put(\"SL-PROPS\", slCustomProps_";
  protected final String TEXT_193 = ");";
  protected final String TEXT_194 = NL + NL + "                            // use Service Activity Monitor" + NL + "                            put(\"useServiceActivityMonitor\", ";
  protected final String TEXT_195 = ");" + NL + "" + NL + "                            boolean use_auth_";
  protected final String TEXT_196 = " = ";
  protected final String TEXT_197 = ";" + NL + "                            if (use_auth_";
  ...
  protected final String TEXT_207 = ") {" + NL + "                                put(\"useServiceRegistry\", ";
  protected final String TEXT_208 = ");" + NL + "                                put(\"username\", ";
  protected final String TEXT_209 = ");" + NL + "                                put(\"password\", decryptedPassword_";
  protected final String TEXT_210 = ");";
  protected final String TEXT_211 = NL + "                                    put(\"role\", ";
  protected final String TEXT_212 = ");";
  protected final String TEXT_213 = NL + "                                    put(\"useCrypto\", ";
  protected final String TEXT_214 = ");";
  protected final String TEXT_215 = NL + "                            } else if (use_auth_";
  protected final String TEXT_216 = ") {" + NL + "                                if (\"SAML\".equals(";
  protected final String TEXT_217 = ")) {";
  protected final String TEXT_218 = NL + "                                    put(\"role\", ";
  protected final String TEXT_219 = ");";
  protected final String TEXT_220 = NL + "                                    put(\"useCrypto\", ";
  protected final String TEXT_221 = ");";
  protected final String TEXT_222 = NL + "                                }" + NL + "                                put(\"esbSecurity\", ";
  ...
  protected final String TEXT_227 = ");" + NL + "                            }" + NL + "\t\t\t\t\t\t\tput(\"httpHeadersFeature\", httpHeadersFeature);";
  ...
  protected final String TEXT_237 = NL + "                                put(\"useGZipCompression\", true);";
  protected final String TEXT_238 = "\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t" + NL + "                        }};" + NL + "" + NL + "                        public String getEndpointUri() {" + NL + "                            // projectName + \"_\" + processName + \"_\" + componentName" + NL + "                            return \"";
  protected final String TEXT_239 = "_";
  protected final String TEXT_240 = "_";
  protected final String TEXT_241 = "\";" + NL + "                        }" + NL + "" + NL + "                        public java.util.Map<String, Object> getEndpointProperties() {" + NL + "                            return props;" + NL + "                        }" + NL + "" + NL + "                        public String getEndpointKey() {" + NL + "                            return \"cxf\";" + NL + "                        }" + NL + "                    }" + NL + "                );" + NL + "" + NL + "                Object request_";
  protected final String TEXT_242 = " = wrapPayload(requestTalendDoc_";
  protected final String TEXT_243 = ".getDocument(), customProps_";
  protected final String TEXT_244 = ");" + NL + "                Object consumerResponse_";
  protected final String TEXT_245 = " = consumer_";
  protected final String TEXT_246 = ".invoke(request_";
  protected final String TEXT_247 = ");" + NL + "                if (null == consumerResponse_";
  protected final String TEXT_248 = ") {" + NL + "                    // one way call" + NL + "                } else {" + NL + "                    if(consumerResponse_";
  protected final String TEXT_249 = " instanceof java.util.Map) {" + NL + "                        java.util.Map<?,?> responseMap_";
  protected final String TEXT_250 = " = (java.util.Map<?,?>)consumerResponse_";
  protected final String TEXT_251 = ";" + NL + "                        responseDoc_";
  protected final String TEXT_252 = " = (org.dom4j.Document) responseMap_";
  protected final String TEXT_253 = ".get(\"payload\");";
  protected final String TEXT_254 = NL + "                            globalMap.put(\"";
  protected final String TEXT_255 = "_CORRELATION_ID\", responseMap_";
  protected final String TEXT_256 = ".get(org.talend.esb.policy.correlation.feature.CorrelationIDFeature.MESSAGE_CORRELATION_ID));";
  protected final String TEXT_257 = NL + "                    } else if (consumerResponse_";
  protected final String TEXT_258 = " instanceof org.dom4j.Document) {" + NL + "                        responseDoc_";
  protected final String TEXT_259 = " = (org.dom4j.Document) consumerResponse_";
  protected final String TEXT_260 = ";" + NL + "                    } else {" + NL + "                        throw new RuntimeException(\"Incompatible consumer response: \" + consumerResponse_";
  protected final String TEXT_261 = ".getClass().getName());" + NL + "                    }" + NL + "                    " + NL + "                    globalMap.put(\"";
  protected final String TEXT_262 = "_HTTP_HEADERS\", httpHeadersFeature.getResponseHeaders());" + NL + "               \t    globalMap.put(\"";
  protected final String TEXT_263 = "_HTTP_RESPONSE_CODE\", httpHeadersFeature.getResponseCode());" + NL + "                }" + NL + "            }";
  protected final String TEXT_264 = NL + "                if (";
  protected final String TEXT_265 = " == null) {";
  protected final String TEXT_266 = NL + "                    ";
  protected final String TEXT_267 = " = new ";
  protected final String TEXT_268 = "Struct();" + NL + "                }" + NL + "                routines.system.Document responseTalendDoc_";
  protected final String TEXT_269 = " = null;" + NL + "                if (null != responseDoc_";
  protected final String TEXT_270 = ") {" + NL + "                    responseTalendDoc_";
  protected final String TEXT_271 = " = new routines.system.Document();" + NL + "                    responseTalendDoc_";
  protected final String TEXT_272 = ".setDocument(responseDoc_";
  protected final String TEXT_273 = ");" + NL + "                }";
  protected final String TEXT_274 = NL + "                ";
  protected final String TEXT_275 = ".payload = responseTalendDoc_";
  protected final String TEXT_276 = ";";
  protected final String TEXT_277 = NL + "        } catch (Exception e_";
  protected final String TEXT_278 = ") {" + NL + "            java.util.Map<String, Object> faultInfo_";
  protected final String TEXT_279 = " = collectFaultInfo(e_";
  protected final String TEXT_280 = ");" + NL + "            if (null == faultInfo_";
  protected final String TEXT_281 = ") {" + NL + "                throw e_";
  protected final String TEXT_282 = "; // non fault exception" + NL + "            }";
  ...
  protected final String TEXT_289 = ".faultCode = (String) faultInfo_";
  protected final String TEXT_290 = ".get(\"faultCode\");";
  protected final String TEXT_291 = NL + "                ";
  protected final String TEXT_292 = ".faultString = (String) faultInfo_";
  protected final String TEXT_293 = ".get(\"faultString\");";
  protected final String TEXT_294 = NL + "                ";
  protected final String TEXT_295 = ".faultActor = (String) faultInfo_";
  protected final String TEXT_296 = ".get(\"faultActor\");";
  protected final String TEXT_297 = NL + "                ";
  protected final String TEXT_298 = ".faultNode = (String) faultInfo_";
  protected final String TEXT_299 = ".get(\"faultNode\");";
  protected final String TEXT_300 = NL + "                ";
  protected final String TEXT_301 = ".faultRole = (String) faultInfo_";
  protected final String TEXT_302 = ".get(\"faultRole\");" + NL + "" + NL + "                if (null != faultInfo_";
  protected final String TEXT_303 = ".get(\"faultDetail\")) {";
  protected final String TEXT_304 = NL + "                    ";
  protected final String TEXT_305 = ".faultDetail = new routines.system.Document();";
  protected final String TEXT_306 = NL + "                    ";
  protected final String TEXT_307 = ".faultDetail.setDocument((org.dom4j.Document) faultInfo_";
  protected final String TEXT_308 = ".get(\"faultDetail\"));" + NL + "                }" + NL;
  protected final String TEXT_309 = NL + "                printFaultInfo(faultInfo_";
  protected final String TEXT_310 = ");" + NL + "                e_";
  protected final String TEXT_311 = ".printStackTrace(System.err);";
  protected final String TEXT_312 = NL + "        }" + NL + "    } catch (Exception e_";
  protected final String TEXT_313 = "){";
  protected final String TEXT_314 = NL + "            throw(e_";
  protected final String TEXT_315 = ");";
  protected final String TEXT_316 = NL + "            new TalendException(e_";
  protected final String TEXT_317 = ", currentComponent, globalMap).printStackTrace();";
  protected final String TEXT_318 = NL + "    }" + NL + "    " + NL + "    if(httpHeadersFeature!=null){" + NL + "    \t globalMap.put(\"";
  protected final String TEXT_319 = "_HTTP_HEADERS\", httpHeadersFeature.getResponseHeaders());" + NL + "       globalMap.put(\"";
  protected final String TEXT_320 = "_HTTP_RESPONSE_CODE\",  httpHeadersFeature.getResponseCode());" + NL + "    }" + NL;
