...
public class TMysqlInputBeginJava
{
  ...
  protected final String TEXT_199 = NL + "\t\t\t//check if year is null in DB" + NL + "\t\t\tString yearStringValue_";
  ...
  protected final String TEXT_203 = ");" + NL + "\t\t\tif (null != yearStringValue_";
  protected final String TEXT_204 = ") {" + NL + "\t\t\t\tInteger yearValue_";
  protected final String TEXT_205 = " = rs_";
  protected final String TEXT_206 = ".getInt(";
  protected final String TEXT_207 = "column_index_";
  protected final String TEXT_208 = ");" + NL + "\t\t\t\tcalendar_";
  protected final String TEXT_209 = ".set(yearValue_";
  protected final String TEXT_210 = ", 0, 1);" + NL + "\t\t\t\t";
  protected final String TEXT_211 = ".";
  protected final String TEXT_212 = " = calendar_";
  protected final String TEXT_213 = ".getTime();" + NL + "\t\t\t} else {" + NL + "\t\t\t\t";
  protected final String TEXT_214 = ".";
  protected final String TEXT_215 = " = null;" + NL + "\t\t\t}";
  protected final String TEXT_216 = NL + "\t\t\t\tif(rs_";
  protected final String TEXT_217 = ".getString(";
  protected final String TEXT_218 = "column_index_";
  protected final String TEXT_219 = ") != null) {" + NL + "\t\t\t\t\tString dateString_";
  ...
  protected final String TEXT_223 = ");" + NL + "\t\t\t\t\tif (!(\"0000-00-00\").equals(dateString_";
  protected final String TEXT_224 = ") && !(\"0000-00-00 00:00:00\").equals(dateString_";
  ...
  protected final String TEXT_232 = " = (java.util.Date) year0_";
  protected final String TEXT_233 = ".clone();" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_274 = " = null;" + NL + "" + NL + "\t\t    try {" + NL + "\t\t    \trs_";
  ...
  protected final String TEXT_340 = NL + "\t\t    \tlog.debug(\"";
  ...
  protected final String TEXT_401 = NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_402 = ".getColumnTypeName(i_";
  protected final String TEXT_403 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_404 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_405 = ".getClob(i_";
  protected final String TEXT_406 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_407 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_408 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_409 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_410 = ".add(tNTextImpl_";
  protected final String TEXT_411 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_412 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  ...
  protected final String TEXT_432 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_433 = ".";
  protected final String TEXT_434 = ", rs_";
  protected final String TEXT_435 = ", fixedColumnCount_";
  protected final String TEXT_436 = ",";
  protected final String TEXT_437 = ");";
  protected final String TEXT_438 = NL + "                                  Object geom = rs_";
  protected final String TEXT_439 = ".getObject(";
  protected final String TEXT_440 = "column_index_";
  protected final String TEXT_441 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o =" + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_442 = ".";
  protected final String TEXT_443 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
  ...
  protected final String TEXT_450 = " - Retrieving the record \" + nb_line_";
