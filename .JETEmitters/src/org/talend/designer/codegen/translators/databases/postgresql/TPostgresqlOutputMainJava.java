...
public class TPostgresqlOutputMainJava {
  ...
  protected final String TEXT_422 = " = null;" + NL + "    String keyPsmt_";
  protected final String TEXT_423 = " = conn_";
  protected final String TEXT_424 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_425 = " + \"]\";" + NL + "    if(GlobalResource.resourceMap.get(keyPsmt_";
  protected final String TEXT_426 = ")== null){" + NL + "        pstmt_";
  protected final String TEXT_427 = " = conn_";
  protected final String TEXT_428 = ".prepareStatement(insert_";
  protected final String TEXT_429 = ");" + NL + "        GlobalResource.resourceMap.put(keyPsmt_";
  protected final String TEXT_430 = ", pstmt_";
  protected final String TEXT_431 = ");" + NL + "    }else{" + NL + "        pstmt_";
  protected final String TEXT_432 = " = (java.sql.PreparedStatement)GlobalResource.resourceMap.get(keyPsmt_";
  ...
  protected final String TEXT_437 = ", \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_444 = " + \"\\\" SET \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_474 = ", \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_490 = "\");" + NL + "\t    pstmtInsert_";
  protected final String TEXT_491 = " = conn_";
  protected final String TEXT_492 = ".prepareStatement(insert_";
  protected final String TEXT_493 = ");" + NL + "\t    pstmtUpdate_";
  ...
  protected final String TEXT_759 = NL + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_760 = " = pstmt_";
  protected final String TEXT_761 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_762 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_763 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_764 = " = rs_";
  protected final String TEXT_765 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
