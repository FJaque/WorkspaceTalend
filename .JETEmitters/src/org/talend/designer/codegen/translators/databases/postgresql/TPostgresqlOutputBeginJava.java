...
public class TPostgresqlOutputBeginJava {
  ...
  protected final String TEXT_505 = " = null;" + NL + "\t\t\tString keyPsmt_";
  protected final String TEXT_506 = " = conn_";
  protected final String TEXT_507 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_508 = " + \"]\";" + NL + "      pstmt_";
  protected final String TEXT_509 = " = SharedDBPreparedStatement.getSharedPreparedStatement(conn_";
  protected final String TEXT_510 = ",insert_";
  protected final String TEXT_511 = ",keyPsmt_";
  ...
  protected final String TEXT_544 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_550 = ") VALUES (";
  protected final String TEXT_551 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_555 = NL + "\t    String delete_";
  protected final String TEXT_556 = " = \"DELETE FROM \\\"\" + tableName_";
