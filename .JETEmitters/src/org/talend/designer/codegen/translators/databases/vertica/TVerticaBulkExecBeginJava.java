...
public class TVerticaBulkExecBeginJava {
  ...
  protected final String TEXT_307 = " - Creating table ";
  protected final String TEXT_308 = "\" + tableName_";
  ...
  protected final String TEXT_315 = " - Create table ";
  protected final String TEXT_316 = "\" + tableName_";
  protected final String TEXT_317 = " + \"";
  protected final String TEXT_318 = " has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_319 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_320 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  ...
  protected final String TEXT_326 = " - Droping table ";
  ...
  protected final String TEXT_334 = " - Drop table ";
  ...
  protected final String TEXT_343 = " - Creating table ";
  ...
  protected final String TEXT_351 = " - Create table ";
  ...
  protected final String TEXT_361 = " - Clearing table ";
  ...
  protected final String TEXT_369 = "- Clear table ";
  protected final String TEXT_370 = "\" + tableName_";
  ...
  protected final String TEXT_384 = " - Trancating table ";
  ...
  protected final String TEXT_392 = " - Truncate table ";
  ...
  protected final String TEXT_403 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_404 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_405 = ".commit();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_406 = NL + "try {";
  protected final String TEXT_407 = NL + "        int keyCount_";
  protected final String TEXT_408 = " = ";
  protected final String TEXT_409 = ";" + NL + "        if(keyCount_";
  protected final String TEXT_410 = " == 0) {" + NL + "            throw new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "        }" + NL + "        tableName_";
  protected final String TEXT_411 = " = \"tmp_";
  protected final String TEXT_412 = "\" + pid + Thread.currentThread().getId();" + NL + "        if(dbschema_";
  protected final String TEXT_413 = " != null && dbschema_";
  protected final String TEXT_414 = ".trim().length() != 0) {" + NL + "\t    \ttableName_";
  protected final String TEXT_415 = " = dbschema_";
  protected final String TEXT_416 = " + \".\" + tableName_";
  protected final String TEXT_417 = ";" + NL + "\t\t}" + NL + "" + NL + "\t\tString sql_create_tmpdb = \"";
  protected final String TEXT_418 = ")\";" + NL;
  protected final String TEXT_419 = NL + "\t\tCharacter OUT_DELIM_";
  protected final String TEXT_420 = " = ";
  protected final String TEXT_421 = ".charAt(0);" + NL + "\t\t";
  protected final String TEXT_422 = NL + "\t\tString escapechar_";
  protected final String TEXT_423 = " = ";
  protected final String TEXT_424 = ";" + NL + "\t\tif(!escapechar_";
  protected final String TEXT_425 = ".isEmpty()){" + NL + "\t\t\tescapechar_";
  protected final String TEXT_426 = " = \"\" + escapechar_";
  protected final String TEXT_427 = ".charAt(0);" + NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_428 = NL + "\t\tString sql_";
  protected final String TEXT_429 = " = \"COPY \" + tableName_";
  protected final String TEXT_430 = " " + NL + "\t\t";
  protected final String TEXT_431 = NL + "\t\t\t+ \"";
  protected final String TEXT_432 = "\"" + NL + "\t\t";
  protected final String TEXT_433 = "\t\t" + NL + "\t\t+ \" FROM STDIN ";
  protected final String TEXT_434 = " ";
  protected final String TEXT_435 = " DELIMITER '\" + OUT_DELIM_";
  protected final String TEXT_436 = " + \"'\"" + NL + "\t\t";
  protected final String TEXT_437 = NL + "\t\t+ \" TRAILING NULLCOLS\"" + NL + "\t\t";
  protected final String TEXT_438 = NL + "\t\t";
  protected final String TEXT_439 = NL + "\t\t+ \" SKIP \" + ";
  protected final String TEXT_440 = NL + "\t\t";
  protected final String TEXT_441 = NL + "\t\t";
  protected final String TEXT_442 = NL + "\t\t+ \" RECORD TERMINATOR E'\" + ";
  protected final String TEXT_443 = " + \"'\"" + NL + "\t\t";
  protected final String TEXT_444 = NL + "\t\t";
  protected final String TEXT_445 = NL + "\t\t+ \" ENCLOSED BY E'\" + ";
  protected final String TEXT_446 = " + \"'\"" + NL + "\t\t";
  protected final String TEXT_447 = NL + "\t\t";
  protected final String TEXT_448 = NL + "\t\t+ \" ENFORCELENGTH\"" + NL + "\t\t";
  protected final String TEXT_449 = NL + "\t\t";
  protected final String TEXT_450 = NL + "\t\t+ \" REJECTMAX \" + ";
  protected final String TEXT_451 = NL + "\t\t";
  protected final String TEXT_452 = NL + "\t\t";
  protected final String TEXT_453 = NL + "\t\t+ \" ABORT ON ERROR\"" + NL + "\t\t";
  protected final String TEXT_454 = NL + "\t\t";
  protected final String TEXT_455 = NL + "\t\t+ \" ESCAPE AS '\" + escapechar_";
  protected final String TEXT_456 = " + \"'\"" + NL + "\t\t";
  protected final String TEXT_457 = NL + "\t\t+\" NO ESCAPE\"" + NL + "\t\t";
  protected final String TEXT_458 = NL + "\t    ";
  protected final String TEXT_459 = " + \" NULL '\"  + ";
  protected final String TEXT_460 = " + \"'\"" + NL + "\t\t";
  protected final String TEXT_461 = NL + "\t\t";
  protected final String TEXT_462 = " + \" DIRECT\"";
  protected final String TEXT_463 = NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_464 = NL + "\t\t\t+ \" REJECTED DATA '\" + ";
  protected final String TEXT_465 = " + \"'\"" + NL + "\t\t";
  protected final String TEXT_466 = NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_467 = NL + "\t\t\t+ \" EXCEPTIONS '\" + ";
  protected final String TEXT_468 = " + \"'\"" + NL + "\t\t";
  protected final String TEXT_469 = NL + "\t    ";
  protected final String TEXT_470 = NL + "\t        + \" NO COMMIT\"" + NL + "\t    ";
  protected final String TEXT_471 = NL + "\t\t;" + NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_472 = NL + "\t\t\tlog.debug(\"";
  protected final String TEXT_473 = " - Bulk SQL:\"+sql_";
  protected final String TEXT_474 = "+\".\");" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_475 = " - Bulk inserting data into ";
  protected final String TEXT_476 = "\" + tableName_";
  protected final String TEXT_477 = " + \"";
  protected final String TEXT_478 = ".\" );";
  protected final String TEXT_479 = NL + "\t    java.sql.Statement stmt_";
  protected final String TEXT_480 = " = conn_";
  protected final String TEXT_481 = ".createStatement();" + NL + "\t    java.sql.ResultSet rs_";
  protected final String TEXT_482 = " = stmt_";
  protected final String TEXT_483 = ".executeQuery(\"select count(*) from \" + tableName_";
  protected final String TEXT_484 = ");" + NL + "\t    int nbLineBeforeLoad_";
  protected final String TEXT_485 = " = 0;" + NL + "\t    while (rs_";
  protected final String TEXT_486 = ".next()) {" + NL + "\t    \tnbLineBeforeLoad_";
  protected final String TEXT_487 = " = rs_";
  protected final String TEXT_488 = ".getInt(1);" + NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_489 = NL + "\t\tcom.vertica.jdbc.VerticaCopyStream vcs_";
  protected final String TEXT_490 = " = new com.vertica.jdbc.VerticaCopyStream((com.vertica.jdbc.VerticaConnection)conn_";
  protected final String TEXT_491 = ",sql_";
  protected final String TEXT_492 = ");" + NL + "\t\tvcs_";
  protected final String TEXT_493 = ".start();";
