...
public class TOracleBulkExecBeginJava {
  ...
  protected final String TEXT_493 = NL + "boolean isDirect_";
  protected final String TEXT_494 = " = false;\t";
  protected final String TEXT_495 = NL + NL + "    String ctlf_";
  protected final String TEXT_496 = " = ";
  protected final String TEXT_497 = ";" + NL + "    String logf_";
  protected final String TEXT_498 = " = ";
  protected final String TEXT_499 = "+\".log\";" + NL + "\t" + NL + "\ttry {" + NL + "\t\tjava.io.BufferedReader ctlf_br_";
  protected final String TEXT_500 = " = new java.io.BufferedReader(new java.io.FileReader(ctlf_";
  protected final String TEXT_501 = "));" + NL + "\t\t" + NL + "\t\ttry{" + NL + "\t\t\tString optionLine_";
  protected final String TEXT_502 = " = ctlf_br_";
  protected final String TEXT_503 = ".readLine();" + NL + "\t\t\tString regex_";
  protected final String TEXT_504 = " = \"\\\\bdirect\\\\s*=\\\\s*true\\\\b\";" + NL + "\t\t\tjava.util.regex.Pattern pattern_";
  protected final String TEXT_505 = " = java.util.regex.Pattern.compile(regex_";
  protected final String TEXT_506 = ", java.util.regex.Pattern.CASE_INSENSITIVE);" + NL + "\t\t\tjava.util.regex.Matcher matcher_";
  protected final String TEXT_507 = " = pattern_";
  protected final String TEXT_508 = ".matcher(optionLine_";
  protected final String TEXT_509 = ");" + NL + "\t\t\tisDirect_";
  protected final String TEXT_510 = " = matcher_";
  protected final String TEXT_511 = ".find();\t\t" + NL + "\t\t}" + NL + "\t\tfinally\t{" + NL + "\t\t\tctlf_br_";
  protected final String TEXT_512 = ".close();" + NL + "\t\t}" + NL + "\t}catch(java.io.IOException ioe) {";
  protected final String TEXT_513 = NL + "\t\tthrow ioe;" + NL + "    }" + NL + "\t";
  protected final String TEXT_514 = NL + "\tisDirect_";
  protected final String TEXT_515 = " = ";
  protected final String TEXT_516 = ";" + NL + "    java.lang.StringBuilder optionClause_";
  protected final String TEXT_517 = " = new java.lang.StringBuilder();" + NL + "    optionClause_";
  protected final String TEXT_518 = ".append(\"OPTIONS (\");";
  protected final String TEXT_519 = NL + "            optionClause_";
  protected final String TEXT_520 = ".append(\", \");";
  protected final String TEXT_521 = NL + "                    optionClause_";
  protected final String TEXT_522 = ".append(\"";
  protected final String TEXT_523 = "=(";
  protected final String TEXT_524 = ")\");";
  protected final String TEXT_525 = NL + "                    optionClause_";
  protected final String TEXT_526 = ".append(\"";
  protected final String TEXT_527 = "=";
  protected final String TEXT_528 = "\");";
  protected final String TEXT_529 = NL + "                if(";
  protected final String TEXT_530 = ".split(\",\").length>1){" + NL + "                    optionClause_";
  protected final String TEXT_531 = ".append(\"";
  protected final String TEXT_532 = "=(\"+";
  protected final String TEXT_533 = "+\")\");" + NL + "                }else{" + NL + "                    optionClause_";
  ...
  protected final String TEXT_541 = NL + "                optionClause_";
  protected final String TEXT_542 = ".append(\"";
  protected final String TEXT_543 = "='\"+";
  protected final String TEXT_544 = "+\"'\");";
  protected final String TEXT_545 = NL + "                optionClause_";
  ...
  protected final String TEXT_555 = NL + "    String dataf_";
  protected final String TEXT_556 = " = ";
  protected final String TEXT_557 = " + Thread.currentThread().getId();" + NL + "" + NL + "    String ctlf_";
  protected final String TEXT_558 = " = dataf_";
  protected final String TEXT_559 = " + \".ctl\";" + NL + "" + NL + "    String badf_";
  protected final String TEXT_560 = " = dataf_";
  protected final String TEXT_561 = " + \".bad\";" + NL + "" + NL + "    String dscf_";
  protected final String TEXT_562 = " = dataf_";
  protected final String TEXT_563 = " + \".dsc\";" + NL + "" + NL + "    String logf_";
  protected final String TEXT_564 = " = dataf_";
  protected final String TEXT_565 = " + \".log\";" + NL + "" + NL + "    dataf_";
  protected final String TEXT_566 = " = ";
  protected final String TEXT_567 = ";" + NL + "" + NL + "    java.io.File badFile_";
  protected final String TEXT_568 = " = new java.io.File(badf_";
  protected final String TEXT_569 = ");" + NL + "" + NL + "    if(badFile_";
  protected final String TEXT_570 = ".exists()){" + NL + "" + NL + "        badFile_";
  protected final String TEXT_571 = ".delete();" + NL + "" + NL + "    }" + NL + "    java.io.BufferedWriter bw_";
  protected final String TEXT_572 = " = new java.io.BufferedWriter(new java.io.FileWriter(ctlf_";
  protected final String TEXT_573 = "));" + NL + "    java.io.PrintWriter pw_";
  protected final String TEXT_574 = " = new java.io.PrintWriter(bw_";
  protected final String TEXT_575 = " ,false) ;" + NL + "" + NL + "    pw_";
  protected final String TEXT_576 = ".println(optionClause_";
  protected final String TEXT_577 = ".toString());" + NL + "" + NL + "    pw_";
  protected final String TEXT_578 = ".println(\"LOAD DATA\");" + NL + "    pw_";
  protected final String TEXT_579 = ".println(\"CHARACTERSET '\"+";
  protected final String TEXT_580 = "+\"'\") ;" + NL + "    bw_";
  protected final String TEXT_581 = ".write(\"INFILE '\" + dataf_";
  protected final String TEXT_582 = " + \"'\");" + NL;
  protected final String TEXT_583 = NL + "        bw_";
  protected final String TEXT_584 = ".write(\" \\\"str '|'\\\" \");";
  protected final String TEXT_585 = NL + NL + NL;
  protected final String TEXT_586 = NL + "        bw_";
  protected final String TEXT_587 = ".write(\" \\\"str '\" + ";
  protected final String TEXT_588 = " + \"'\\\"\");";
  protected final String TEXT_589 = NL + "        bw_";
  protected final String TEXT_590 = ".write(\" \\\"fix \" + ";
  protected final String TEXT_591 = " + \"\\\"\");";
  protected final String TEXT_592 = NL + "        bw_";
  protected final String TEXT_593 = ".write(\" \\\"var \" + ";
  protected final String TEXT_594 = " + \"\\\"\");";
  protected final String TEXT_595 = NL + "    pw_";
  protected final String TEXT_596 = ".println(\"\");" + NL + "    pw_";
  protected final String TEXT_597 = ".println(\"BADFILE '\" + badf_";
  protected final String TEXT_598 = " + \"'\" );" + NL + "    pw_";
  protected final String TEXT_599 = ".println(\"DISCARDFILE '\" + dscf_";
  protected final String TEXT_600 = " + \"'\");";
  protected final String TEXT_601 = NL + "        pw_";
  protected final String TEXT_602 = ".println(\"PRESERVE BLANKS\");";
  protected final String TEXT_603 = NL + "        bw_";
  protected final String TEXT_604 = ".write(";
  protected final String TEXT_605 = ");";
  protected final String TEXT_606 = NL + "            pw_";
  protected final String TEXT_607 = ".println(\"INTO TABLE \" + tableName_";
  protected final String TEXT_608 = ");" + NL + "            pw_";
  protected final String TEXT_609 = ".println(\"INSERT\");";
  protected final String TEXT_610 = NL + "            pw_";
  protected final String TEXT_611 = ".println(\"INTO TABLE \" + tableName_";
  protected final String TEXT_612 = ");" + NL + "            pw_";
  protected final String TEXT_613 = ".println(\"";
  protected final String TEXT_614 = "\");";
  protected final String TEXT_615 = NL + "                pw_";
  protected final String TEXT_616 = ".println(\"WHEN \" + ";
  ...
  protected final String TEXT_622 = ".write(\"FIELDS TERMINATED BY \\\"\"+ ";
  protected final String TEXT_623 = " + \"\\\"\");";
  protected final String TEXT_624 = NL + "                bw_";
  protected final String TEXT_625 = ".write(\" OPTIONALLY ENCLOSED BY \");";
  protected final String TEXT_626 = NL + "                bw_";
  protected final String TEXT_627 = ".write(\"FIELDS ENCLOSED BY \");";
  protected final String TEXT_628 = NL + "            bw_";
  protected final String TEXT_629 = ".write(\"'\" + ";
  protected final String TEXT_630 = " + \"'\");";
  protected final String TEXT_631 = NL + "                bw_";
  protected final String TEXT_632 = ".write(\" AND '\" + ";
  protected final String TEXT_633 = " + \"'\");";
  protected final String TEXT_634 = NL + "            pw_";
  protected final String TEXT_635 = ".println(\"\");";
  protected final String TEXT_636 = NL + "            pw_";
  protected final String TEXT_637 = ".println(\"\");";
  protected final String TEXT_638 = NL + "            pw_";
  protected final String TEXT_639 = ".println(\"TRAILING NULLCOLS\");";
  protected final String TEXT_640 = NL + "            pw_";
  protected final String TEXT_641 = ".println(\"";
  protected final String TEXT_642 = "\");";
  protected final String TEXT_643 = NL + "    bw_";
  protected final String TEXT_644 = ".close();" + NL + "    pw_";
  protected final String TEXT_645 = ".close();";
  protected final String TEXT_646 = NL + "String command_";
  protected final String TEXT_647 = " = \"sqlldr '\" + dbUser_";
  protected final String TEXT_648 = " + \"/\" + dbPwd_";
  protected final String TEXT_649 = " + \"@\" + serviceUrl_";
  protected final String TEXT_650 = " + \"' CONTROL='\" + ctlf_";
  protected final String TEXT_651 = " + \"' LOG='\" + logf_";
  protected final String TEXT_652 = " + \"'\";" + NL + "String printableCommand_";
  protected final String TEXT_653 = " = \"sqlldr '\" + dbUser_";
  protected final String TEXT_654 = " + \"/\" + \"....\" + \"@\" + serviceUrl_";
  protected final String TEXT_655 = " + \"' CONTROL='\" + ctlf_";
  protected final String TEXT_656 = " + \"' LOG='\" + logf_";
  protected final String TEXT_657 = " + \"'\";" + NL;
  protected final String TEXT_658 = NL + "    try{" + NL + "    java.sql.Statement stmtCreateTmp_";
  protected final String TEXT_659 = " = conn_";
  protected final String TEXT_660 = ".createStatement();";
  protected final String TEXT_661 = NL + "        log.info(\"";
  protected final String TEXT_662 = " - Creating temp table ";
  protected final String TEXT_663 = "\" + tableName_";
  protected final String TEXT_664 = " + \"";
  protected final String TEXT_665 = ".\" );";
  protected final String TEXT_666 = NL + "    stmtCreateTmp_";
  protected final String TEXT_667 = ".execute(\"";
  protected final String TEXT_668 = ")\");" + NL + "    stmtCreateTmp_";
  protected final String TEXT_669 = ".close();";
  protected final String TEXT_670 = NL + "        log.info(\"";
  protected final String TEXT_671 = " - Create temp table ";
  protected final String TEXT_672 = "\" + tableName_";
  protected final String TEXT_673 = " + \"";
  protected final String TEXT_674 = " has succeeded.\");" + NL + "        log.info(\"";
  protected final String TEXT_675 = " - Executing command:'\" + printableCommand_";
  protected final String TEXT_676 = " + \"'.\");";
  protected final String TEXT_677 = NL + "    final Process process_";
  protected final String TEXT_678 = " = Runtime.getRuntime().exec(command_";
  protected final String TEXT_679 = ");";
  protected final String TEXT_680 = NL + "        java.util.ArrayList<String> envParam_";
  protected final String TEXT_681 = "=new java.util.ArrayList<String>();" + NL + "        java.util.Map<String, String> systemEnvMap_";
  protected final String TEXT_682 = " = System.getenv();" + NL + "        for (java.util.Map.Entry<String, String> entry : systemEnvMap_";
  protected final String TEXT_683 = ".entrySet())" + NL + "        {" + NL + "           envParam_";
  protected final String TEXT_684 = ".add(entry.getKey() + \"=\" + entry.getValue());" + NL + "        }";
  protected final String TEXT_685 = NL + "        envParam_";
  protected final String TEXT_686 = ".add(\"NLS_LANGUAGE=";
  protected final String TEXT_687 = "\");";
  protected final String TEXT_688 = NL + "        envParam_";
  protected final String TEXT_689 = ".add(\"NLS_DATE_LANGUAGE=";
  protected final String TEXT_690 = "\");";
  protected final String TEXT_691 = NL + "            envParam_";
  protected final String TEXT_692 = ".add(\"NLS_TERRITORY=";
  protected final String TEXT_693 = "\");";
  protected final String TEXT_694 = NL + "        envParam_";
  protected final String TEXT_695 = ".add(\"";
  protected final String TEXT_696 = "=";
  protected final String TEXT_697 = "\");";
  protected final String TEXT_698 = NL + "        log.info(\"";
  protected final String TEXT_699 = " - Executing command:'\" + printableCommand_";
  protected final String TEXT_700 = " + \"'.\");";
  protected final String TEXT_701 = NL + "    final Process process_";
  protected final String TEXT_702 = " = Runtime.getRuntime().exec(command_";
  protected final String TEXT_703 = ",envParam_";
  protected final String TEXT_704 = ".toArray(new String[0]));";
  protected final String TEXT_705 = NL + NL + "//System.out.println(command_";
  protected final String TEXT_706 = ");" + NL + "" + NL + "Thread normal_";
  protected final String TEXT_707 = " = new Thread() {" + NL + "    public void run() {" + NL + "        try {" + NL + "            java.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(process_";
  protected final String TEXT_708 = ".getInputStream()));" + NL + "            String line = \"\";" + NL + "            try {" + NL + "                while((line = reader.readLine()) != null) {";
  protected final String TEXT_709 = NL + "                        System.out.println(line);";
  protected final String TEXT_710 = NL + "                        globalMap.put(\"";
  protected final String TEXT_711 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_712 = "_OUTPUT\") + \"\\n\" + line);";
  protected final String TEXT_713 = NL + "                }" + NL + "            } finally {" + NL + "                 reader.close();" + NL + "            }" + NL + "        }catch(java.io.IOException ioe) {";
  protected final String TEXT_714 = NL + "            ioe.printStackTrace();" + NL + "        }" + NL + "    }" + NL + "};" + NL + "" + NL + "normal_";
  protected final String TEXT_715 = ".start();" + NL + "" + NL + "Thread error_";
  protected final String TEXT_716 = " = new Thread() {" + NL + "    public void run() {" + NL + "       try {" + NL + "           java.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(process_";
  protected final String TEXT_717 = ".getErrorStream()));" + NL + "           String line = \"\";" + NL + "           try {" + NL + "               while((line = reader.readLine()) != null) {" + NL + "                  globalMap.put(\"";
  protected final String TEXT_718 = "_SQLLOAD_ERROR\", \"true\");";
  protected final String TEXT_719 = NL + "                       System.err.println(line);";
  protected final String TEXT_720 = NL + "                       globalMap.put(\"";
  protected final String TEXT_721 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_722 = "_OUTPUT\")+\"\\n\"+line);";
  protected final String TEXT_723 = NL + "               }" + NL + "            } finally {" + NL + "                reader.close();" + NL + "            }" + NL + "        } catch(java.io.IOException ioe) {";
  protected final String TEXT_724 = NL + "           ioe.printStackTrace();" + NL + "        }" + NL + "    }" + NL + "};" + NL + "" + NL + "error_";
  protected final String TEXT_725 = ".start();" + NL + "" + NL + "process_";
  protected final String TEXT_726 = ".waitFor();" + NL + "" + NL + "int exitCode_";
  protected final String TEXT_727 = " = process_";
  protected final String TEXT_728 = ".exitValue();" + NL + "" + NL + "" + NL + "normal_";
  protected final String TEXT_729 = ".interrupt();" + NL + "" + NL + "error_";
  protected final String TEXT_730 = ".interrupt();" + NL + "" + NL + "if (\"true\".equals((String)globalMap.get(\"";
  protected final String TEXT_731 = "_SQLLOAD_ERROR\"))) {" + NL + "    throw new TalendException(new java.lang.Exception() , \"";
  protected final String TEXT_732 = "\" , globalMap);" + NL + "}";
  protected final String TEXT_733 = NL + "    log.info(\"";
  protected final String TEXT_734 = " - Excute command: '\" + printableCommand_";
  protected final String TEXT_735 = " + \"' has finished.\");" + NL + "    log.info(\"";
  protected final String TEXT_736 = " - Retrieving information from oracle log file: '\" + logf_";
  protected final String TEXT_737 = " + \"'.\");";
  protected final String TEXT_738 = NL + NL + "int nb_line_data_";
  protected final String TEXT_739 = " = 0;" + NL + "int nb_line_bad_";
  protected final String TEXT_740 = " = 0;" + NL + "int nb_line_inserted_";
  protected final String TEXT_741 = " = 0;" + NL + "int nb_line_discarded_";
  protected final String TEXT_742 = " = 0;" + NL + "" + NL + "/*  1.get log file all lines count" + NL + "    2.get \"Total logical records read\" line number from file end." + NL + "    3.get \"Total logical records read\" and \"Total logical records rejected\" count. */" + NL + "" + NL + "//1" + NL + "" + NL + "class LogUtil_";
  protected final String TEXT_743 = "{" + NL + "    public int getNumber(java.io.BufferedReader br)  throws java.io.IOException {" + NL + "        int number=0;" + NL + "        java.util.regex.Pattern pattern = java.util.regex.Pattern.compile(\"\\\\d{1,}\");" + NL + "        String tempLine = br.readLine();" + NL + "        if(tempLine!=null){" + NL + "            String str_number = tempLine.substring(tempLine.indexOf(\":\") + 1).trim();" + NL + "            boolean isNumber= pattern.matcher(str_number).matches();" + NL + "            if(isNumber){" + NL + "                number = Integer.parseInt(str_number);" + NL + "            }" + NL + "        }" + NL + "        return number;" + NL + "    }" + NL + "\t" + NL + "\tpublic java.io.BufferedReader parseLogFileWithDirect(String logf) throws java.io.IOException" + NL + "\t{" + NL + "\t\tString tempLine = \"\";" + NL + "\t\tjava.io.BufferedReader lr = new java.io.BufferedReader(new java.io.FileReader(logf));" + NL + "\t\tjava.util.List<String> logLineList = new java.util.ArrayList<String>();" + NL + "\t\twhile ((tempLine = lr.readLine() )!= null) {" + NL + "\t\t\tlogLineList.add(tempLine);" + NL + "\t\t}" + NL + "\t\tlr.close();" + NL + "" + NL + "\t\tboolean isFirstEmptyLine = true;//Is the first empty line of empty block" + NL + "\t\tint emptyLineNum =0;//The number of empty block" + NL + "\t\tint beforeNumLine = 0;" + NL + "\t\tfor(int i=logLineList.size()-1; i>=0; i--)" + NL + "\t\t{" + NL + "\t\t\ttempLine = logLineList.get(i);" + NL + "\t\t\tif(tempLine!=null && tempLine.trim().length()>0){" + NL + "\t\t\t\tisFirstEmptyLine = true;" + NL + "\t\t\t}\t" + NL + "\t\t\telse if (isFirstEmptyLine){//skip empty rows" + NL + "\t\t\t\tisFirstEmptyLine = false;" + NL + "\t\t\t\temptyLineNum++;" + NL + "\t\t\t\tif(emptyLineNum==3){" + NL + "\t\t\t\t\tbeforeNumLine = i+1;" + NL + "\t\t\t\t\tbreak;" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t" + NL + "\t\tlr = new java.io.BufferedReader(new java.io.FileReader(logf));" + NL + "\t\tfor (int i=0; i <= beforeNumLine; i++) {" + NL + "\t\t\tlr.readLine();" + NL + "\t\t}\t" + NL + "\t\t" + NL + "\t\treturn lr;" + NL + "\t}" + NL + "\t" + NL + "\tpublic java.io.BufferedReader parseLogFileWithoutDirect(String logf, String tableName) throws java.io.IOException" + NL + "\t{" + NL + "\t\tString tempLine = \"\";" + NL + "\t\tjava.io.BufferedReader lr = new java.io.BufferedReader(new java.io.FileReader(logf));" + NL + "\t\tint countLines =0;//log file lines count" + NL + "\t\tint lastTableLine = 0;//Line Number of the last table name" + NL + "\t\twhile ((tempLine = lr.readLine() )!= null) {" + NL + "\t\t\tcountLines++;" + NL + "\t\t\tif(tempLine.toUpperCase().indexOf(\"TABLE \"+(tableName).toUpperCase())>-1){" + NL + "\t\t\t\tlastTableLine = countLines;" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\tlr.close();" + NL + "\t\t//need new instance to readLine ." + NL + "\t\tlr = new java.io.BufferedReader(new java.io.FileReader(logf));" + NL + "\t\tfor (int i=0; i<= lastTableLine; i++) {" + NL + "\t\t\tlr.readLine();" + NL + "\t\t}" + NL + "\t\tboolean isNumber=false;" + NL + "\t\ttempLine = lr.readLine();" + NL + "\t\tint emptyLineNum =0;//The number of empty block" + NL + "\t\tboolean isFirstEmptyLine = false;//Is the first empty line of empty block" + NL + "\t\tfor (int i=lastTableLine+2; i<= countLines; i++) {" + NL + "\t\t\ttempLine = lr.readLine();" + NL + "\t\t\tif(tempLine!=null && tempLine.trim().length()>0){" + NL + "\t\t\t\tif(emptyLineNum==2){" + NL + "\t\t\t\t\tbreak;" + NL + "\t\t\t\t}" + NL + "\t\t\t\tisFirstEmptyLine = false;" + NL + "\t\t\t\tcontinue;//skip rows now empty" + NL + "\t\t\t}else if (!isFirstEmptyLine){//skip empty rows" + NL + "\t\t\t\tisFirstEmptyLine = true;" + NL + "\t\t\t\temptyLineNum++;" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\treturn lr;" + NL + "\t}" + NL + "\t" + NL + "}" + NL + "" + NL + "LogUtil_";
  protected final String TEXT_744 = " lu_";
  protected final String TEXT_745 = " = new LogUtil_";
  protected final String TEXT_746 = "();" + NL + "java.io.BufferedReader lr_";
  protected final String TEXT_747 = " = null;" + NL + "try {" + NL + "\tif(isDirect_";
  protected final String TEXT_748 = "){" + NL + "\t\tlr_";
  protected final String TEXT_749 = " = lu_";
  protected final String TEXT_750 = ".parseLogFileWithDirect(logf_";
  protected final String TEXT_751 = ");\t\t" + NL + "\t}\t\t" + NL + "\telse{" + NL + "\t\tlr_";
  protected final String TEXT_752 = " = lu_";
  protected final String TEXT_753 = ".parseLogFileWithoutDirect(logf_";
  protected final String TEXT_754 = ", tableName_";
  protected final String TEXT_755 = ");\t" + NL + "\t}" + NL + "" + NL + "\tnb_line_data_";
  protected final String TEXT_756 = " = lu_";
  protected final String TEXT_757 = ".getNumber(lr_";
  protected final String TEXT_758 = ");//get the number of data line" + NL + "\tnb_line_bad_";
  protected final String TEXT_759 = " = lu_";
  protected final String TEXT_760 = ".getNumber(lr_";
  ...
  protected final String TEXT_763 = ".getNumber(lr_";
  ...
  protected final String TEXT_768 = ";" + NL + "} finally {" + NL + "\tlr_";
  protected final String TEXT_769 = ".close();" + NL + "}" + NL + "globalMap.put(\"";
  protected final String TEXT_770 = "_NB_LINE_DATA\", nb_line_data_";
  protected final String TEXT_771 = ");" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_772 = "_NB_LINE_BAD\", nb_line_bad_";
  protected final String TEXT_773 = ");" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_774 = "_NB_LINE_INSERTED\", nb_line_inserted_";
  protected final String TEXT_775 = ");" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_776 = "_RETURN_CODE\", exitCode_";
  protected final String TEXT_777 = ");";
  protected final String TEXT_778 = NL + "    log.info(\"";
  protected final String TEXT_779 = " - Retrieved number of line: \" + nb_line_data_";
  protected final String TEXT_780 = " + \".\");" + NL + "    log.info(\"";
  protected final String TEXT_781 = " - Retrieved number of bad line: \" + nb_line_bad_";
  protected final String TEXT_782 = " + \".\");" + NL + "    log.info(\"";
  protected final String TEXT_783 = " - Retrieved number of inserted line: \" + nb_line_inserted_";
  protected final String TEXT_784 = " + \".\");" + NL + "    log.info(\"";
  protected final String TEXT_785 = " - Retrieved information from oracle log file: '\" + logf_";
  protected final String TEXT_786 = " + \"' finish.\");";
